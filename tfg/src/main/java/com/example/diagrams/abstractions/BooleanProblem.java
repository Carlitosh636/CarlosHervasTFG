...
public class BooleanProblem extends BaseProblem{

    public BooleanProblem(IDiagramActions builder, String diagramDataName) throws IOException {
    ...
    public boolean checkSolutionsEqual(String calcSol, boolean isOther) throws Exception {
        ...
        return Boolean.parseBoolean(ogSol) == Boolean.parseBoolean(calcSol);
    }
    @Override
