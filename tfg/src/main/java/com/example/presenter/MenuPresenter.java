...
public class MenuPresenter {
    ...
    public void initialize() throws IOException {
        ...
        buttonsPaths.put(b5,new ButtonRelatedData(new StringDiagram(new EqualStringsDiagram(),"/diagramData/EqualStringsData.json"),"/generatedData/EqualStringsGeneration.json"));
